                    ...
                    if (resposta.length > 0) {
                        ...
                        for (let i = 0; i < resposta.length; i++) {
                            ...
                            if (resposta[i].uso_cpu >= sessionStorage.getItem('PARAM_CRITICO_CPU')) {
                                document.getElementById(`uso-cpu-atm-${resposta[i].numeracao}`).style.color = '#e63946';
                                document.getElementById(`uso-cpu-atm-${resposta[i].numeracao}`).style.fontWeight =
                                    'bold';
                                document.getElementById(`status-monitoramento-atm-${resposta[i].numeracao}`).innerText =
                                    'Crítico';
                                document
                            ...
                            } else if (resposta[i].uso_cpu >= sessionStorage.getItem('PARAM_IMPORTANTE_CPU')) {
                                document.getElementById(`uso-cpu-atm-${resposta[i].numeracao}`).style.color = '#f4a261';
                                document.getElementById(`uso-cpu-atm-${resposta[i].numeracao}`).style.fontWeight =
                                    'bold';
                                document.getElementById(`status-monitoramento-atm-${resposta[i].numeracao}`).innerText =
                                    'Importante';
                            ...
                            if (resposta[i].uso_ram >= sessionStorage.getItem('PARAM_CRITICO_RAM')) {
                                document.getElementById(`uso-ram-atm-${resposta[i].numeracao}`).style.color = '#e63946';
                                document.getElementById(`uso-ram-atm-${resposta[i].numeracao}`).style.fontWeight =
                                    'bold';
                                document.getElementById(`status-monitoramento-atm-${resposta[i].numeracao}`).innerText =
                                    'Crítico';
                                document
                                ...
                                document
                                    .getElementById(`status-monitoramento-atm-${resposta[i].numeracao}`)
                                    .classList.add('celula-critico');
                            } else if (resposta[i].uso_ram >= sessionStorage.getItem('PARAM_IMPORTANTE_RAM')) {
                                document.getElementById(`uso-ram-atm-${resposta[i].numeracao}`).style.color = '#f4a261';
                                document.getElementById(`uso-ram-atm-${resposta[i].numeracao}`).style.fontWeight =
                                    'bold';
                                document.getElementById(`status-monitoramento-atm-${resposta[i].numeracao}`).innerText =
                                    'Importante';
                            ...
                            if (resposta[i].uso_disco >= sessionStorage.getItem('PARAM_CRITICO_DISCO')) {
                                document.getElementById(`uso-disco-atm-${resposta[i].numeracao}`).style.color =
                                    '#e63946';
                                document.getElementById(`uso-disco-atm-${resposta[i].numeracao}`).style.fontWeight =
                                    'bold';
                                document.getElementById(`status-monitoramento-atm-${resposta[i].numeracao}`).innerText =
                                    'Crítico';
                                document
                                ...
                                document
                                    .getElementById(`status-monitoramento-atm-${resposta[i].numeracao}`)
                                    .classList.add('celula-critico');
                            } else if (resposta[i].uso_disco >= sessionStorage.getItem('PARAM_IMPORTANTE_DISCO')) {
                                document.getElementById(`uso-disco-atm-${resposta[i].numeracao}`).style.color =
                                    '#f4a261';
                                document.getElementById(`uso-disco-atm-${resposta[i].numeracao}`).style.fontWeight =
                                    'bold';
